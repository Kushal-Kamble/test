...
function App() {
  ...
  return (
    ...
    <div className="container kushal">
      ...
      {
        //  login == false ? <Headerr/>  : <div style={{color: "red"}}>Dekh le bhai true hai condition</div>
      }
     ...
     {/* {
       (() => {
        ...
        if(login) {
          // return <Headerr/>
          return <div style={{color: "pink", fontSize: "30px"}}><b>Dekh le true hai bhawa</b></div>
        }else{
      ...
      <Headerr/>
       ...
       <div className='main'>
        ...
        {
          demo.map((element, index) => {  // map function ka use krke sare object ko  ek ek karke return krega
